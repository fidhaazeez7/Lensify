...
export default function DashboardStats({
  ...
  const healthScore = result.health.score;
  ...
  return (
    <div className="mx-auto mt-8 grid max-w-7xl gap-6 px-8 md:grid-cols-2 xl:grid-cols-4">
      <StatCard
        ...
        title="Total Files"
        value={result.analysis.total_files.toString()}
        color="bg-blue-50"
      />
      ...
      <StatCard
        ...
        title="Bugs Found"
        value={result.bugs.length.toString()}
        color="bg-red-50"
      />
      ...
      <StatCard
        ...
        value={result.security.length.toString()}
        color="bg-green-50"
      />
...
function StatCard({
  ...
  return (
    <div
      className={`rounded-3xl border border-slate-200 ${color} p-6 shadow-sm`}
    >
